...
function Card() {
    return(
        ...
        <div className="glass-morphic box-content flex flex-col justify-center items-center text-center border-2 shadow-2xl shadow-gray-700 p-4 pt-8 gap-6 rounded-2xl bg-gradient-to-r from-purple-800 via-fuchsia-700 to-pink-900">
