...
function Hero() {
  return (
    <div className='min-h-min w-full p-10 mt-40'>
       <div className='flex shadow-slate-500 shadow-md h-auto glass-morphic-hero  w-full rounded-2xl about_us2'>
       <div className='w-3/5 p-10 hero1 '>
       <div> <h3 className='text-xl font-semibold mb-4'><span className='bg-yellow-300 pt-2 pb-2 pl-4'>ED</span>C BIT ,MESRA</h3>
             <h2 className='text-2xl font-bold mb-4 '>Our Stats</h2>
             <p className=' w-3/4 text-sm hero1'>With a team of dedicated experts and professionals, we bring a wealth of experience and knowledge to every project. Our deep industry insights and hands-on experience enable us to tackle
       ...
       <div className=' w-full h-1/2 flex mt-2 flex-col gap-8'>
         ...
         <div className=' flex items-center pt-5 justify-start gap-24'>  
      ...
      <div className='flex gap-24'>   <div className=' w-24  flex flex-col items-center'>
        ...
        <div className='w-2/5 p-8 flex flex-col gap-6 hero1'>
